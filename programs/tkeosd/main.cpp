...
int main(int argc, char** argv)
{
   try {
      ...
      app().set_default_data_dir(home / "telos-wallet");
      app().set_default_config_dir(home / "telos-wallet");
      ...
      http.add_handler("/v1/tkeosd/stop", [](string, string, url_response_callback cb) { cb(200, "{}"); std::raise(SIGTERM); } );
      app().startup();
      app().exec();
