...
BOOST_FIXTURE_TEST_CASE( vote_for_producer, eosio_system_tester, * boost::unit_test::tolerance(10) ) try {
   produce_blocks(3600);
   ...
   BOOST_TEST_REQUIRE( stake2votes(core_from_string("11.1111"), 1, 1) == prod["total_votes"].as_double() );
   BOOST_REQUIRE_EQUAL( "alice1111111", prod["owner"].as_string() );
   BOOST_REQUIRE_EQUAL( "http://block.one", prod["url"].as_string() );
   BOOST_REQUIRE_EQUAL( get_global_state()["total_producer_vote_weight"].as<double>(), get_producer_info( "alice1111111" )["total_votes"].as_double() );
   ...
   prod = get_producer_info( "alice1111111" );
   BOOST_TEST_REQUIRE( stake2votes(core_from_string("22.2222"), 1, 1) + stake2votes(core_from_string("11.1111"), 1, 1) == prod["total_votes"].as_double() );
   BOOST_REQUIRE_EQUAL( get_global_state()["total_producer_vote_weight"].as<double>(), get_producer_info( "alice1111111" )["total_votes"].as_double() );
   ...
   prod = get_producer_info( "alice1111111" );
   BOOST_TEST_REQUIRE( stake2votes(core_from_string("22.2222"), 1, 1) + stake2votes(core_from_string("44.4444"), 1, 1) == prod["total_votes"].as_double() );
   BOOST_REQUIRE_EQUAL( get_global_state()["total_producer_vote_weight"].as<double>(), get_producer_info( "alice1111111" )["total_votes"].as_double() );
   ...
   prod = get_producer_info( "alice1111111" );
   BOOST_TEST_REQUIRE( stake2votes(core_from_string("22.2222"), 1, 1) + stake2votes(core_from_string("66.6666"), 1, 1) == prod["total_votes"].as_double() );
   BOOST_REQUIRE_EQUAL( get_global_state()["total_producer_vote_weight"].as<double>(), get_producer_info( "alice1111111" )["total_votes"].as_double() );
   ...
   prod = get_producer_info( "alice1111111" );
   wdump((prod));
   BOOST_TEST_REQUIRE( stake2votes(core_from_string("20.2220"), 1, 1) + stake2votes(core_from_string("66.6666"), 1, 1) == prod["total_votes"].as_double() );
   BOOST_REQUIRE_EQUAL( get_global_state()["total_producer_vote_weight"].as<double>(), get_producer_info( "alice1111111" )["total_votes"].as_double() );
   ...
   //should decrease alice1111111's total_votes
   prod = get_producer_info( "alice1111111" );
   BOOST_TEST_REQUIRE( stake2votes(core_from_string("20.2220"), 1, 1) == prod["total_votes"].as_double() );
   BOOST_REQUIRE_EQUAL( get_global_state()["total_producer_vote_weight"].as<double>(), get_producer_info( "alice1111111" )["total_votes"].as_double() );
...
BOOST_FIXTURE_TEST_CASE( unregistered_producer_voting, eosio_system_tester, * boost::unit_test::tolerance(10) ) try {
   issue( "bob111111111", core_from_string("2000.0000"),  config::system_account_name );
...
BOOST_FIXTURE_TEST_CASE( producer_keep_votes, eosio_system_tester, * boost::unit_test::tolerance(10) ) try {
   issue( "alice1111111", core_from_string("1000.0000"),  config::system_account_name );
   fc::variant params = producer_parameters_example(1);
   ...
   auto prod = get_producer_info( "alice1111111" );
   BOOST_TEST_REQUIRE( stake2votes(core_from_string("13.5791"), 1, 1) == prod["total_votes"].as_double() );
...
BOOST_FIXTURE_TEST_CASE( vote_for_two_producers, eosio_system_tester, * boost::unit_test::tolerance(10) ) try {
   //alice1111111 becomes a producer
   fc::variant params = producer_parameters_example(1);
   ...
   BOOST_TEST_REQUIRE( stake2votes(core_from_string("20.0005"), 2, 2) == alice_info["total_votes"].as_double() );
   auto bob_info = get_producer_info( "bob111111111" );
   BOOST_TEST_REQUIRE( stake2votes(core_from_string("20.0005"), 2, 2) == bob_info["total_votes"].as_double() );

   //carol1111111 votes for alice1111111 (but revokes vote for bob111111111)
   BOOST_REQUIRE_EQUAL( success(), vote( N(carol1111111), { N(alice1111111) } ) );

   alice_info = get_producer_info( "alice1111111" );
   BOOST_TEST_REQUIRE( stake2votes(core_from_string("20.0005"), 1, 2) == alice_info["total_votes"].as_double() );
   ...
   alice_info = get_producer_info( "alice1111111" );
   BOOST_TEST_REQUIRE( stake2votes(core_from_string("20.0005"), 1, 2) + stake2votes(core_from_string("2.0000"), 2, 2) == alice_info["total_votes"].as_double() );

   bob_info = get_producer_info( "bob111111111" );
   BOOST_TEST_REQUIRE( stake2votes(core_from_string("2.0000"), 2, 2) == bob_info["total_votes"].as_double() );
...
BOOST_FIXTURE_TEST_CASE( proxy_actions_affect_producers, eosio_system_tester, * boost::unit_test::tolerance(10) ) try {
   ...
   BOOST_TEST_REQUIRE( stake2votes(core_from_string("150.0003"), 2, 3) == get_producer_info( "defproducer1" )["total_votes"].as_double() );
   BOOST_TEST_REQUIRE( stake2votes(core_from_string("150.0003"), 2, 3) == get_producer_info( "defproducer2" )["total_votes"].as_double() );
   ...
   BOOST_TEST_REQUIRE( stake2votes(core_from_string("150.0003"), 2, 3) == get_producer_info( "defproducer3" )["total_votes"].as_double() );
   ...
   BOOST_REQUIRE_EQUAL( stake2votes(core_from_string("200.0005"), 2, 3), get_producer_info( "defproducer1" )["total_votes"].as_double() );
   BOOST_REQUIRE_EQUAL( 0, get_producer_info( "defproducer2" )["total_votes"].as_double() );
   BOOST_REQUIRE_EQUAL( stake2votes(core_from_string("200.0005"), 2, 3), get_producer_info( "defproducer3" )["total_votes"].as_double() );
   ...
   BOOST_TEST_REQUIRE( stake2votes(core_from_string("180.0003"), 2, 3) == get_producer_info( "defproducer1" )["total_votes"].as_double() );
   BOOST_REQUIRE_EQUAL( 0, get_producer_info( "defproducer2" )["total_votes"].as_double() );
   BOOST_TEST_REQUIRE( stake2votes(core_from_string("180.0003"), 2, 3) == get_producer_info( "defproducer3" )["total_votes"].as_double() );
...
BOOST_FIXTURE_TEST_CASE( voter_and_proxy_actions_affect_producers_and_totals, eosio_system_tester, * boost::unit_test::tolerance(10) ) try {
   ...
   BOOST_REQUIRE_EQUAL( success(), stake( "alice1111111", core_from_string("30.0001"), core_from_string("20.0001") ) );
   BOOST_REQUIRE_EQUAL( success(), vote( N(alice1111111), { N(defproducer1), N(defproducer2) } ) );
   auto expected_value = stake2votes(core_from_string("50.0002"),2,3);
   ...
   expected_value = stake2votes(core_from_string("50.0002"),2,3) * 2;
   BOOST_TEST_REQUIRE( expected_value == get_producer_info( "defproducer1" )["total_votes"].as_double() );
   BOOST_TEST_REQUIRE( expected_value == get_producer_info( "defproducer2" )["total_votes"].as_double() );
   BOOST_REQUIRE_EQUAL( 0, get_producer_info( "defproducer3" )["total_votes"].as_double() );
...
BOOST_FIXTURE_TEST_CASE( voters_actions_affect_proxy_and_producers, eosio_system_tester, * boost::unit_test::tolerance(10) ) try {
   produce_blocks(3600);
   ...
   BOOST_REQUIRE_EQUAL( success(), stake( "alice1111111", core_from_string("30.0001"), core_from_string("20.0001") ) );
   BOOST_REQUIRE_EQUAL( success(), vote( N(alice1111111), { N(defproducer1), N(defproducer2) } ) );
   BOOST_TEST_REQUIRE( stake2votes(core_from_string("50.0002"),2,3) == get_producer_info( "defproducer1" )["total_votes"].as_double() );
   BOOST_TEST_REQUIRE( stake2votes(core_from_string("50.0002"),2,3) == get_producer_info( "defproducer2" )["total_votes"].as_double() );
   BOOST_REQUIRE_EQUAL( 0, get_producer_info( "defproducer3" )["total_votes"].as_double() );
   ...
   BOOST_TEST_REQUIRE( stake2votes(core_from_string("200.0005"),2,3) == get_producer_info( "defproducer1" )["total_votes"].as_double() );
   BOOST_TEST_REQUIRE( stake2votes(core_from_string("200.0005"),2,3) == get_producer_info( "defproducer2" )["total_votes"].as_double() );
   BOOST_REQUIRE_EQUAL( 0, get_producer_info( "defproducer3" )["total_votes"].as_double() );
   ...
   BOOST_TEST_REQUIRE( stake2votes(core_from_string("250.0007"),2,3) == get_producer_info( "defproducer1" )["total_votes"].as_double() );
   BOOST_TEST_REQUIRE( stake2votes(core_from_string("250.0007"),2,3) == get_producer_info( "defproducer2" )["total_votes"].as_double() );
   BOOST_REQUIRE_EQUAL( 0, get_producer_info( "defproducer3" )["total_votes"].as_double() );
   ...
   BOOST_TEST_REQUIRE( stake2votes(core_from_string("370.0007"),2,3) == get_producer_info( "defproducer1" )["total_votes"].as_double() );
   BOOST_TEST_REQUIRE( stake2votes(core_from_string("370.0007"),2,3) == get_producer_info( "defproducer2" )["total_votes"].as_double() );
   BOOST_REQUIRE_EQUAL( 0, get_producer_info( "defproducer3" )["total_votes"].as_double() );
   ...
   BOOST_TEST_REQUIRE( stake2votes(core_from_string("270.0005"),2,3) == get_producer_info( "defproducer1" )["total_votes"].as_double() );
   BOOST_TEST_REQUIRE( stake2votes(core_from_string("270.0005"),2,3) == get_producer_info( "defproducer2" )["total_votes"].as_double() );
   BOOST_REQUIRE_EQUAL( 0, get_producer_info( "defproducer3" )["total_votes"].as_double() );
   ...
   BOOST_TEST_REQUIRE( stake2votes(core_from_string("100.0003"),2,3), get_producer_info( "defproducer1" )["total_votes"].as_double() );
   BOOST_TEST_REQUIRE( stake2votes(core_from_string("100.0003"),2,3), get_producer_info( "defproducer2" )["total_votes"].as_double() );
   BOOST_REQUIRE_EQUAL( 0, get_producer_info( "defproducer3" )["total_votes"].as_double() );
   ...
   BOOST_TEST_REQUIRE( stake2votes(core_from_string("50.0002"),2,3), get_producer_info( "defproducer1" )["total_votes"].as_double() );
   BOOST_TEST_REQUIRE( stake2votes(core_from_string("100.0003"),1,3), get_producer_info( "defproducer2" )["total_votes"].as_double() );
