...
PASSWORD_INITA=${PASSWORD_INITA%\"}
programs/teclos/teclos wallet import --name inita $INITA_PRV_KEY
verifyErrorCode "teclos wallet import"
programs/teclos/teclos wallet import --name inita $PRV_KEY1
verifyErrorCode "teclos wallet import"
programs/teclos/teclos wallet import --name inita $PRV_KEY2
verifyErrorCode "teclos wallet import"
programs/teclos/teclos wallet import --name inita $PRV_KEY3
verifyErrorCode "teclos wallet import"
